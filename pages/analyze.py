...
def load_models():
    ...
    stage2 = tf.keras.models.load_model("model/ResNet50_best.keras")
...
def load_models():
    ...
    # Stage 2 models (3-model ensemble)
    model1 = tf.keras.models.load_model("model/best_model_ResNet50_4Class_Pathogen.keras")
    model2 = tf.keras.models.load_model("model/final_model_ResNet50_4Class_Pathogen.keras")
    model3 = tf.keras.models.load_model("model/ResNet50_best.keras")

    return stage1, model1, model2, model3


stage1_model, m1, m2, m3 = load_models()
        ...
        if st.session_state.run_analysis:
            ...
            with st.status("Running Two-Stage AI Analysis...",expanded=True) as status:
                ...
                if stage1_label == "Diseased":
                    ...
                    stage2_probs = final_pred[0] * 100
                    predicted_class = stage2_classes[np.argmax(stage2_probs)]
